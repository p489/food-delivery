...
class OrderItem(models.Model):
	product = models.ForeignKey(thing, on_delete=models.SET_NULL, null=True)
	...
	@property
	def get_total(self):
		total = self.product.thing_price * self.quantity
		return total
